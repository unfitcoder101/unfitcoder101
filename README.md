...
4 merged PRs across production LLMOps codebases at YC-backed startups (26k★ repos). I verify root cause before touching code, and ship fixes maintainers don't have to rewrite.              
